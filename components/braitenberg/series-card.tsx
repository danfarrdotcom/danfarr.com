  ...
  const card = (
    <div className="grid gap-2 border-b border-stone-300 py-5 md:grid-cols-[8rem_1fr_auto] md:items-start md:gap-6">
      ...
      <div>
        ...
        <p className="mt-2 text-[1.02rem] leading-7 text-stone-700">
          {entry.hook}
        </p>
        <p className="mt-2 text-[0.95rem] leading-6 text-stone-500">
          {entry.description}
        </p>
      </div>
      <div className="text-[11px] uppercase tracking-[0.24em] text-stone-500 md:pt-1">
        {entry.status}
      </div>
    </div>
  );
