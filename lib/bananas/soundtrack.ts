...
// Notes
const Bb2 = 116.54, F3 = 174.61, G3 = 196.0, Bb3 = 233.08,
  C4 = 261.63, D4 = 293.66, Eb4 = 311.13, F4 = 349.23,
  G4 = 392.0, A4 = 440.0, Bb4 = 466.16,
  C5 = 523.25, D5 = 587.33, Eb5 = 622.25, F5 = 698.46,
  G5 = 783.99, Bb5 = 932.33;
...
const BASS_ROOTS: [number, number][] = [
  [Bb2, 0], [Bb2, 4], [Bb2, 8], [Bb2, 12],
  [G3, 16], [G3, 20], [F3, 24], [F3, 28],
];
...
const BRASS: NoteEvent[] = [
  // Bars 1-2
  [Bb4, 0, 0.2], [D5, 0, 0.2], [F5, 0, 0.2],
  [REST, 0.2, 1.3],
  [Bb4, 2, 0.2], [D5, 2, 0.2], [F5, 2, 0.2],
  [Bb4, 2.5, 0.2], [D5, 2.5, 0.2],
  [REST, 2.7, 1.3],
  [Bb4, 4, 0.2], [D5, 4, 0.2], [F5, 4, 0.2],
  [REST, 4.2, 1.3],
  [Bb4, 6, 0.2], [D5, 6, 0.2], [F5, 6, 0.2],
  [Bb4, 6.5, 0.2], [D5, 6.5, 0.2],
  [REST, 6.7, 1.3],
  // Bars 3-4
  [G4, 8, 0.2], [Bb4, 8, 0.2], [D5, 8, 0.2],
  [REST, 8.2, 1.3],
  [G4, 10, 0.2], [Bb4, 10, 0.2], [D5, 10, 0.2],
  [G4, 10.5, 0.2], [Bb4, 10.5, 0.2],
  [REST, 10.7, 1.3],
  [F4, 12, 0.2], [A4, 12, 0.2], [C5, 12, 0.2],
  [REST, 12.2, 1.3],
  [F4, 14, 0.2], [A4, 14, 0.2], [C5, 14, 0.2],
  [REST, 14.2, 1.8],
  // Bars 5-6: sustained for woo-hoo
  [Bb4, 16, 1.5], [D5, 16, 1.5],
  [REST, 17.5, 0.5],
  [Bb4, 18.5, 1.5], [D5, 18.5, 1.5],
  [REST, 20, 0.5],
  [Bb4, 21.5, 1.5], [D5, 21.5, 1.5],
  [REST, 23, 1],
  // Bars 7-8: spelling stabs
  [Bb4, 24, 0.2], [D5, 24, 0.2], [F5, 24, 0.2],
  [G4, 24.75, 0.2], [Bb4, 24.75, 0.2],
  [Bb4, 25.5, 0.2], [D5, 25.5, 0.2], [F5, 25.5, 0.2],
  [G4, 26, 0.2], [Bb4, 26, 0.2],
  [Bb4, 26.75, 0.2], [D5, 26.75, 0.2], [F5, 26.75, 0.2],
  [G4, 27.5, 0.2], [Bb4, 27.5, 0.2],
  [Bb4, 28, 1.5], [D5, 28, 1.5], [F5, 28, 1.5], [Bb5, 28, 1.5],
  [REST, 29.5, 2.5],
];
