    ...
    <main className="min-h-screen px-5 py-8 md:px-8 md:py-12">
      <div className="mx-auto max-w-[48rem]">
        ...
        <header className="max-w-3xl border-b border-stone-300 pb-10">
          ...
          <p className="mt-6 text-[1.28rem] leading-9 text-stone-700 md:text-[1.45rem]">
            A series of interactive plates and essays that restage the core
            mechanisms from <em>Vehicles: Experiments in Synthetic Psychology</em>
            {' '}in a browser, with as little visual noise as possible.
          </p>
          <p className="mt-4 max-w-2xl text-[1.02rem] leading-7 text-stone-600">
